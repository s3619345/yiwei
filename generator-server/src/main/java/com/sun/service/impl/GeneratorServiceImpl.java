...
import com.sun.domain.ColumnInfo;
import com.sun.domain.GenConfig;
import com.sun.domain.vo.TableInfo;
import com.sun.exception.BadRequestException;
import com.sun.repository.ColumnInfoRepository;
import com.sun.service.GeneratorService;
import com.sun.utils.GenUtil;
...
//            FileUtil.downloadFile(request, response, new File(zipPath), true);
    ...
    public static void main(String[] args) {
        ...
        genConfig.setId(1L);
        genConfig.setTableName("sys_user");
        ColumnInfo columnInfo = new ColumnInfo();
        columnInfo.setId(1L);
        columnInfo.setTableName("sys_user");
        columnInfo.setColumnName("username");
        columnInfo.setColumnType("string");
        ArrayList<ColumnInfo> list = new ArrayList<>();
        list.add(columnInfo);
        generatorTest(genConfig,list);
    }
    public static void generatorTest(GenConfig genConfig, List<ColumnInfo> columns) {
        final String CONFIG_MESSAGE = "请先配置生成器";
        if (genConfig.getId() == null) {
            throw new BadRequestException(CONFIG_MESSAGE);
        }
        try {
